...
Этот milestone функционально завершает setup integration #29 и parent #13, но не [epic #5](https://github.com/AlexMyln/netcraze-xray-routerkit/issues/5). Bootstrap остаётся явным; autostart — #14, device discovery — #21, Netcraze proxy/policy — #15, hardware validation — #16. Integrated path не считается hardware-tested до завершения #16.
