...
- with explicit `setup --plan-netcraze --netcraze-state-file PATH`, run a protected fixture-first connection/policy/optional-assignment plan before confirmation, without a Netcraze write;
