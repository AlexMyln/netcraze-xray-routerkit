...
| --- | --- | --- | --- | --- |
| Command Reference Guide, Hero KN-1011, OS 4.0 | Keenetic Limited | https://docs.help.keenetic.com/cli/4.0/en/cli_manual_kn-1011.pdf | The CLI guide defines command metadata, including whether a command changes settings, and includes an HTTP API section for `/rci`. | official_documented |
| `show ip dhcp bindings` | Keenetic Limited | https://docs.help.keenetic.com/cli/4.0/en/cli_manual_kn-1011.pdf | The command is documented as read-only and returns DHCP lease records with IP, MAC, expiry, and hostname fields. | official_documented |
| `show associations` | Keenetic Limited | https://docs.help.keenetic.com/cli/4.0/en/cli_manual_kn-1011.pdf | The command is documented as read-only and returns Wi-Fi station association records with MAC, AP/interface, authentication, uptime, and radio metrics. | official_documented |
| `show ip hotspot summary` | Keenetic Limited | https://docs.help.keenetic.com/cli/4.0/en/cli_manual_kn-1011.pdf | The command is documented as read-only and summarizes registered hosts, including active state and names, for traffic counters. | official_documented |
...
- `show ip dhcp bindings`, `show associations`, and `show ip hotspot summary` are documented as read-only commands.
...
- deterministic normalization, stable-ID deduplication, sorting, JSON/text rendering, redaction, and selection;
