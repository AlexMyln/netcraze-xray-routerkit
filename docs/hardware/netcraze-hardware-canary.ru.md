...
Hard ceiling — 120 минут. Stop conditions и phase timeout важнее расписания.
...
Минимум 15 минут всегда резервируются для P13. Reentry после narrow patch допустим только при остатке не менее 30 минут.
